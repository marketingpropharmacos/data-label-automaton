@echo off
title ProPharmacos - Setup Autostart v2 (PC da Edi)
color 0B
chcp 65001 >nul 2>&1

echo.
echo ============================================================
echo  ProPharmacos - Setup Autostart v2 - PC DA EDI
...
(
    echo @echo off
    echo title ProPharmacos - Agente de Impressao [Edi]
    echo color 0A
    echo.
    ...
    echo echo.
    echo echo [%%date%% %%time%%] ============================================
    echo echo  ProPharmacos - Agente de Impressao [Edi]
    echo echo ============================================
...
REM Adicionar nova entrada via cmd (necessario para .bat)
...
REM ---- Metodo 3: Task Scheduler SEM /rl HIGHEST (backup 2) ----
echo.
echo [5/5] Configurando Task Scheduler (metodo backup 2)...

schtasks /delete /tn "ProPharmacos_Agente" /f >nul 2>&1

REM Criar tarefa SEM privilegios elevados (evita bloqueio UAC)
...
echo.
echo ============================================================
echo  CONFIGURACAO V2 CONCLUIDA - PC DA EDI
echo.
